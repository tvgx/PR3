...
// Dữ liệu giả
const cartItems = [
  { id: 1, name: "LCD Monitor", price: 650, quantity: 1, image: "/placeholder.svg" },
  { id: 2, name: "H1 Gamepad", price: 550, quantity: 2, image: "/placeholder.svg" },
];
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex flex-col gap-6">
        {/* Header */}
        <div className="hidden md:grid grid-cols-4 gap-4 p-4 font-medium shadow-sm rounded-md">
          <div>Product</div>
          <div>Price</div>
          <div>Quantity</div>
        ...
        {cartItems.map((item) => (
          <div
            key={item.id}
            className="grid grid-cols-2 md:grid-cols-4 gap-4 items-center p-4 shadow-sm rounded-md"
          >
            {/* Product */}
